...
{	
	...
	/// </summary>
	public Rect windowDimensions = new Rect(0,0,300,300);
	...
	/// </summary>
	public delegate string SelectFileFunction(Status status, string path);
	...
	{
		GetFile(Application.persistentDataPath, Callback, extension);
	}
